<?= require '/xampp/htdocs/rabi/views/partials/head.php'?>
<body class="h-full">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/controllers/notes/notes.php" class="<?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Notes</a>
...
<?= require '/xampp/htdocs/rabi/views/partials/footer.php'?>
